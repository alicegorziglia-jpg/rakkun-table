 ...
 *
 * Provides types, structs, and function pointers needed to compile against NVENC.
 * The actual implementation is in nvEncodeAPI64.dll, loaded at runtime from the
 * user's NVIDIA driver. windows.h must be included before this header.
 *
...
// windows.h must already be included — it defines GUID and HRESULT.
#ifndef _WINDOWS_
#  include <windows.h>
#endif
#include <stdint.h>
...
// ---------------------------------------------------------------------------
// GUIDs — reuse the Windows GUID type; do NOT redefine _GUID
// ---------------------------------------------------------------------------
...
static const GUID NV_ENC_PRESET_P1_GUID =
    { 0xFC0A8D3E, 0x45F3, 0x4332, { 0xBF,0x6B,0xFA,0x7B,0x40,0x36,0x30,0x40 } };
...
static const GUID NV_ENC_PRESET_P3_GUID =
    { 0x36850110, 0x3A07, 0x441F, { 0x94,0xD5,0x39,0x70,0xD5,0x9E,0xB8,0xBF } };
static const GUID NV_ENC_PRESET_P4_GUID =
    { 0x90A7B826, 0xDF06, 0x4862, { 0xB9,0xD2,0xCD,0x6D,0x73,0xA0,0x88,0x34 } };
static const GUID NV_ENC_PRESET_P5_GUID =
    { 0x21C6E6EF, 0x8D5E, 0x4C1E, { 0xB6,0x24,0xE0,0x5F,0x9B,0x60,0x89,0xBF } };
static const GUID NV_ENC_PRESET_P6_GUID =
    { 0x8E75C279, 0x6299, 0x4AB6, { 0x83,0x52,0x0C,0xBE,0x0B,0x26,0x80,0x51 } };
static const GUID NV_ENC_PRESET_P7_GUID =
    { 0x84848C12, 0x6F71, 0x4C13, { 0xBE,0x3A,0xC9,0xB4,0x45,0x57,0x83,0x46 } };

static const GUID NV_ENC_CODEC_PROFILE_AUTOSELECT_GUID =
    { 0xBFD6F8E7, 0x233C, 0x4341, { 0x8B,0x3E,0x46,0x26,0xF9,0x96,0xF2,0x04 } };
static const GUID NV_ENC_H264_PROFILE_BASELINE_GUID =
    { 0x727BCAA2, 0xDF84, 0x4770, { 0xAF,0xBE,0x38,0x40,0x37,0xD9,0x72,0x67 } };
...
static const GUID NV_ENC_H264_PROFILE_HIGH_GUID =
    { 0xE7CBC309, 0x4F7A, 0x4B34, { 0xB3,0x2B,0x18,0x41,0x8B,0xCC,0xE3,0x85 } };
...
typedef NVENCSTATUS (NVENCAPI* PNVENCGETENCODEPRESETCOUNT)  (void*, GUID, uint32_t*);
typedef NVENCSTATUS (NVENCAPI* PNVENCGETENCODEPRESETGUIDS)  (void*, GUID, uint32_t, uint32_t*, GUID*);
...
// NvEncodeAPIGetMaxSupportedVersion is a free DLL export, NOT in the table.
typedef NVENCSTATUS (NVENCAPI* PFN_NvEncodeAPIGetMaxSupportedVersion)(uint32_t*);

// ---------------------------------------------------------------------------
// Function list (SDK 12)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Entry point exported by nvEncodeAPI64.dll
// ---------------------------------------------------------------------------
